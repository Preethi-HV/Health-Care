...
public final class ActivityHealthArticlesBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityHealthArticlesBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ActivityHealthArticlesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_health_articles, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHealthArticlesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHealthArticlesBinding((ConstraintLayout) rootView, buttonHADBack,
          listViewHA, textViewHADTitle, textViewLogo3);
    }
