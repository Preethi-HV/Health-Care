...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
                    ...
                    {"Vitamin B Complex Capsules", "", "", "", "448"},
                            {"Inlife Vitamin E wheat gram oil capsule", "", "", "", "539"},
                            {"Dolo 650 Tablet", "", "", "", "30"},
    ...
    private String[] package_details = {
            "Building and keeping the bones & teeth strong\n"+
                    "Reduce Fatigue/stress and muscular pains\n" +
                    "Boosting immunity and increasing resistance aganist infection",
            "chromium is an essential trace mineral that plays an important role in helping insulin regulate boold glucose.",
            "Provides relief from vitamin B deficiencies\n"+
                    "Helps in formation of red blood cells\n"+
                    "Maintains healthy nervous system",
            "it promotes health as well as skin benifit.\n"+
                    "it helps reduce skin blemish and pigmentation.\n"+
                    "it act as safegurad the skin from the harsh UVA and UVB sun rays.",
            ...
            "helps relieve fever and bring down a high temperature\n"+
                    "suitable for people with aheart condition or high blood pressure",
            ...
            "Reduce the risk of calcium deficiency, Rickets ,and Osteoporosis\n+" +
                    "Promototes mobility and flexibility of joints",
